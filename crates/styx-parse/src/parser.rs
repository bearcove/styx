...
pub struct Parser<'src> {
    lexer: Peekable<TokenizerIter<'src>>,
}

/// Wrapper to make Tokenizer into an Iterator.
struct TokenizerIter<'src> {
    lexer: Tokenizer<'src>,
    done: bool,
}

impl<'src> Iterator for TokenizerIter<'src> {
    type Item = Token<'src>;
...
impl<'src> Parser<'src> {
    ...
    pub fn new(source: &'src str) -> Self {
        ...
        Self {
            lexer: TokenizerIter { lexer, done: false }.peekable(),
        }
    }
